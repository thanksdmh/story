...
#   CONSTRAINT `FK_Reference_5` FOREIGN KEY (`uid`) REFERENCES `author` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
#   CONSTRAINT `FK_Reference_6` FOREIGN KEY (`fuid`) REFERENCES `author` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT
