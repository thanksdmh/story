...
　　ORM框架就是用于实现ORM技术的程序。
    ...
    # sqlalchemy两个主要配置
    # ORM底层所访问数据库URI
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123456@127.0.0.1/story'
    # 当关闭数据库是否自动提交事务
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123456@localhost/story?charset=utf8'
...
class TestConfig(Config):
    ...
    #可以通过修改SQLALCHEMY_DATABASE_URI来控制访问不同数据库
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123456@localhost/story'
