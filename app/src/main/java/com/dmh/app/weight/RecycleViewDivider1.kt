...
//
///**
// * Created by dengmaohua on 2018/11/26 16:33.
// */
...
//    private var mOrientation: Int = 1//列表的方向：LinearLayoutManager.VERTICAL或LinearLayoutManager.HORIZONTAL
...
//        Constructor(context, orientation):this(con)
...
//     */
//    fun RecycleViewDivider(context: Context, orientation: Int, dividerHeight: Int, dividerColor: Int) {
//        this.RecycleViewDivider(context, orientation)
